...
class TareaNormal(Tarea):  # Clases que heredan de Tarea
    def mostrar_info(self):
        return f"Tarea Normal - {self.titulo}"


class TareaUrgente(Tarea):  # Clases que heredan de Tarea
    def mostrar_info(self):
        return f"Tarea Urgente - {self.titulo}"


class TareaProgramada(Tarea):  # Clases que heredan de Tarea
    def mostrar_info(self):
